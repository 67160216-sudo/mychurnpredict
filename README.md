...
Plaintext
├── notebooks/
│   └── model2.ipynb          # ไฟล์หลักที่ใช้ทำ EDA, Feature Engineering และ Modeling
├── reports/
│   ├── customer_risk_scores.csv   # รายชื่อลูกค้าพร้อมคะแนนความเสี่ยง
│   └── plots/                # กราฟประกอบการวิเคราะห์ (จาก Notebook)
